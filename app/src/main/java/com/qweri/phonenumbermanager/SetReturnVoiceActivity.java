...
public class SetReturnVoiceActivity extends AppCompatActivity {
	...
	private RadioButton mButton1, mButton2, mButton3, mButton4;
	private Toolbar mToolbar;

	public static String[] serviceNumberList = new String[]{"tel:**67*13800312309%23","tel:**67*13800000000%23","tel:**67*13810538911%23","tel:%23%2367%23"};
	public static String[] sServiceDescList = new String[]{"暂时无法接通","号码是空号","直接挂断","默认"};
